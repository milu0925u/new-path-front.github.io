...
import DrawUnity from "@/component/nosharable/unity/draw-unity";
...
export default function Draw() {
  ...
  const {
    ...
    loaderUrl: "/unity/DrawScene/DrawScene_0628c.loader.js",
    dataUrl: "/unity/DrawScene/DrawScene_0628c.data",
    frameworkUrl: "/unity/DrawScene/DrawScene_0628c.framework.js",
    codeUrl: "/unity/DrawScene/DrawScene_0628c.wasm",
    // loaderUrl: "/unity/DrawScene/Build/DrawScene_0801.loader.js",
    // dataUrl: "/unity/DrawScene/Build/DrawScene_0801.data",
    // frameworkUrl: "/unity/DrawScene/Build/DrawScene_0801.framework.js",
    // codeUrl: "/unity/DrawScene/Build/DrawScene_0801.wasm",
    // loaderUrl: "/unity/DrawScene/testbuild/DrawScene_0628.loader.js",
    // dataUrl: "/unity/DrawScene/testbuild/DrawScene_0628.data",
    // frameworkUrl: "/unity/DrawScene/testbuild/DrawScene_0628.framework.js",
    // codeUrl: "/unity/DrawScene/testbuild/DrawScene_0628.wasm",
    webglContextAttributes: {
      preserveDrawingBuffer: false, //為了性能調低
    },
  });
      ...
      >
        ...
        <div className={`draw_tools ${!openTool ? "unity_unvisible" : ""}`}>
          {drawList.map((item, i) => (
            ...
            >
              <img ait="draw" src={`/images/unity/${item.img}.svg`} />
              <span>{item.name}</span>
            </div>
          ))}
          {openDraw && (
