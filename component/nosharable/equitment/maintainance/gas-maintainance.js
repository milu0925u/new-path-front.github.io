...
export default function GasMaintainance({ text }) {
  const { datas } = useSelector((state) => state.public);

  return (
    <div className={style.maintainance}>
      <div className="content-title">{datas.airsupplyequipment}</div>
      <div>
        <span>{datas.airsupplyequipment}：</span>
