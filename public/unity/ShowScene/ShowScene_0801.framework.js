function unityFramework(Module) {
  ...
  function _AbleGetData(able) {
    window.dispatchReactUnityEvent("AbleGetData", UTF8ToString(able));
  }
  function _AbleGetModel(able) {
    window.dispatchReactUnityEvent("AbleGetModel", UTF8ToString(able));
  }
  function _AbleGetURL(able) {
    window.dispatchReactUnityEvent("AbleGetURL", UTF8ToString(able));
  }
  function _AlarmAcitve(able) {
    window.dispatchReactUnityEvent("AlarmAcitve", UTF8ToString(able));
  }
  function _DownLoadPLY(data, length) {
    var byteArray = new Uint8Array(length);
    for (var i = 0; i < length; i++) {
      byteArray[i] = getValue(data + i, "i8");
    }
    window.dispatchReactUnityEvent("DownLoadPLY", byteArray);
  }
  ...
  function _DownloadPicture(picture) {
    window.dispatchReactUnityEvent("DownloadPicture", UTF8ToString(picture));
  }
  function _IsUploadData(able) {
    window.dispatchReactUnityEvent("IsUploadData", UTF8ToString(able));
  }
  ...
  function _JS_DOM_MapViewportCoordinateToElementLocalCoordinate(
    ...
    if (canvas) {
      ...
      // Canvas not found, set targetX and targetY to 0
      HEAPU32[targetX >> 2] = 0;
      HEAPU32[targetY >> 2] = 0;
    }
  }
  ...
  function _SendPlyByte(data, length) {
    var byteArray = new Uint8Array(length);
    for (var i = 0; i < length; i++) {
      byteArray[i] = getValue(data + i, "i8");
    }
    window.dispatchReactUnityEvent("SendPlyByte", byteArray);
  }
  function _SendPlyData(data) {
    window.dispatchReactUnityEvent("SendPlyData", UTF8ToString(data));
  }
  function _SettingClosed(able) {
    window.dispatchReactUnityEvent("SettingClosed", UTF8ToString(able));
  }
  function _TurnToFix(able) {
    window.dispatchReactUnityEvent("TurnToFix", UTF8ToString(able));
  }
  function _TurnToHistory(able) {
    window.dispatchReactUnityEvent("TurnToHistory", UTF8ToString(able));
  }
  function _TurnToRobot(able) {
    window.dispatchReactUnityEvent("TurnToRobot", UTF8ToString(able));
  }
  function _UIListActive(able) {
    window.dispatchReactUnityEvent("UIListActive", UTF8ToString(able));
  }
  ...
  function _Uploaded(able) {
    window.dispatchReactUnityEvent("Uploaded", UTF8ToString(able));
  }
  ...
  var asmLibraryArg = {
    ...
    Fh: _DownloadPicture,
    pc: _IsUploadData,
    Ae: _JS_Accelerometer_IsRunning,
    ...
    nc: ___sys_getegid32,
    oc: ___sys_geteuid32,
    Zc: ___sys_getpeername,
    fd: ___sys_getrusage,
    qg: ___sys_getsockname,
    Og: ___sys_getsockopt,
    hf: ___sys_getuid32,
    fb: ___sys_ioctl,
    hg: ___sys_listen,
    Sc: ___sys_lstat64,
    ...
    de: _emscripten_set_main_loop_timing,
    ...
    rh: _glAttachShader,
    Tb: _glBeginQuery,
    _f: _glBeginTransformFeedback,
    wa: _glBindAttribLocation,
    qh: _glBindBuffer,
    xf: _glBindBufferBase,
    wf: _glBindBufferRange,
    nh: _glBindFramebuffer,
    oh: _glBindRenderbuffer,
    qf: _glBindSampler,
    ph: _glBindTexture,
    Sf: _glBindTransformFeedback,
    Vf: _glBindVertexArray,
    ic: _glBlendEquation,
    ...
    Tf: _glDeleteTransformFeedbacks,
    Yf: _glDeleteVertexArrays,
    va: _glDepthFunc,
    ua: _glDepthMask,
    Rg: _glDetachShader,
    Qg: _glDisable,
    Pg: _glDisableVertexAttribArray,
    Lg: _glDrawArrays,
  ...
  var _malloc = (Module["_malloc"] = function () {
    return (_malloc = Module["_malloc"] = Module["asm"]["ni"]).apply(
      null,
      arguments
    );
  });
  var _free = (Module["_free"] = function () {
    return (_free = Module["_free"] = Module["asm"]["oi"]).apply(
      null,
      arguments
    );
  });
  var _memalign = (Module["_memalign"] = function () {
    return (_memalign = Module["_memalign"] = Module["asm"]["pi"]).apply(
      null,
      arguments
    );
  });
  var _memset = (Module["_memset"] = function () {
    return (_memset = Module["_memset"] = Module["asm"]["qi"]).apply(
      null,
      arguments
    );
  });
  var _strlen = (Module["_strlen"] = function () {
    return (_strlen = Module["_strlen"] = Module["asm"]["ri"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_vii = (Module["dynCall_vii"] = function () {
    return (dynCall_vii = Module["dynCall_vii"] = Module["asm"]["ui"]).apply(
      null,
      arguments
    );
  });
  var dynCall_iii = (Module["dynCall_iii"] = function () {
    return (dynCall_iii = Module["dynCall_iii"] = Module["asm"]["vi"]).apply(
      null,
      arguments
    );
  });
  var dynCall_ii = (Module["dynCall_ii"] = function () {
    return (dynCall_ii = Module["dynCall_ii"] = Module["asm"]["wi"]).apply(
      null,
      arguments
    );
  });
  var dynCall_iiii = (Module["dynCall_iiii"] = function () {
    return (dynCall_iiii = Module["dynCall_iiii"] = Module["asm"]["xi"]).apply(
      null,
      arguments
    );
  });
  var dynCall_jiji = (Module["dynCall_jiji"] = function () {
    return (dynCall_jiji = Module["dynCall_jiji"] = Module["asm"]["yi"]).apply(
      null,
      arguments
    );
  });
  var dynCall_vi = (Module["dynCall_vi"] = function () {
    return (dynCall_vi = Module["dynCall_vi"] = Module["asm"]["zi"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_viii = (Module["dynCall_viii"] = function () {
    return (dynCall_viii = Module["dynCall_viii"] = Module["asm"]["Bi"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_i = (Module["dynCall_i"] = function () {
    return (dynCall_i = Module["dynCall_i"] = Module["asm"]["Gi"]).apply(
      null,
      arguments
    );
  });
  var dynCall_iiij = (Module["dynCall_iiij"] = function () {
    return (dynCall_iiij = Module["dynCall_iiij"] = Module["asm"]["Hi"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_iij = (Module["dynCall_iij"] = function () {
    return (dynCall_iij = Module["dynCall_iij"] = Module["asm"]["Li"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_jii = (Module["dynCall_jii"] = function () {
    return (dynCall_jii = Module["dynCall_jii"] = Module["asm"]["Ni"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_jiii = (Module["dynCall_jiii"] = function () {
    return (dynCall_jiii = Module["dynCall_jiii"] = Module["asm"]["Pi"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_fiii = (Module["dynCall_fiii"] = function () {
    return (dynCall_fiii = Module["dynCall_fiii"] = Module["asm"]["Zi"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_iifi = (Module["dynCall_iifi"] = function () {
    return (dynCall_iifi = Module["dynCall_iifi"] = Module["asm"]["$i"]).apply(
      null,
      arguments
    );
  });
  var dynCall_diii = (Module["dynCall_diii"] = function () {
    return (dynCall_diii = Module["dynCall_diii"] = Module["asm"]["aj"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_ijji = (Module["dynCall_ijji"] = function () {
    return (dynCall_ijji = Module["dynCall_ijji"] = Module["asm"]["hj"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_iffi = (Module["dynCall_iffi"] = function () {
    return (dynCall_iffi = Module["dynCall_iffi"] = Module["asm"]["vj"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_fii = (Module["dynCall_fii"] = function () {
    return (dynCall_fii = Module["dynCall_fii"] = Module["asm"]["xj"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_viji = (Module["dynCall_viji"] = function () {
    return (dynCall_viji = Module["dynCall_viji"] = Module["asm"]["zj"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_fi = (Module["dynCall_fi"] = function () {
    return (dynCall_fi = Module["dynCall_fi"] = Module["asm"]["Jj"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_j = (Module["dynCall_j"] = function () {
    return (dynCall_j = Module["dynCall_j"] = Module["asm"]["Sj"]).apply(
      null,
      arguments
    );
  });
  var dynCall_jijj = (Module["dynCall_jijj"] = function () {
    return (dynCall_jijj = Module["dynCall_jijj"] = Module["asm"]["Tj"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_fifi = (Module["dynCall_fifi"] = function () {
    return (dynCall_fifi = Module["dynCall_fifi"] = Module["asm"]["Wj"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_fffi = (Module["dynCall_fffi"] = function () {
    return (dynCall_fffi = Module["dynCall_fffi"] = Module["asm"]["dk"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_viij = (Module["dynCall_viij"] = function () {
    return (dynCall_viij = Module["dynCall_viij"] = Module["asm"]["jk"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_ffi = (Module["dynCall_ffi"] = function () {
    return (dynCall_ffi = Module["dynCall_ffi"] = Module["asm"]["yk"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_viiiiiiififffi = (Module["dynCall_viiiiiiififffi"] = function () {
    return (dynCall_viiiiiiififffi = Module["dynCall_viiiiiiififffi"] =
      Module["asm"]["Jk"]).apply(null, arguments);
  });
  var dynCall_viiiiiiiiffffi = (Module["dynCall_viiiiiiiiffffi"] = function () {
    return (dynCall_viiiiiiiiffffi = Module["dynCall_viiiiiiiiffffi"] =
      Module["asm"]["Kk"]).apply(null, arguments);
  });
  ...
  var dynCall_ifii = (Module["dynCall_ifii"] = function () {
    return (dynCall_ifii = Module["dynCall_ifii"] = Module["asm"]["Sk"]).apply(
      null,
      arguments
    );
  });
  var dynCall_iififfi = (Module["dynCall_iififfi"] = function () {
    return (dynCall_iififfi = Module["dynCall_iififfi"] =
      Module["asm"]["Tk"]).apply(null, arguments);
  });
  var dynCall_iffiffi = (Module["dynCall_iffiffi"] = function () {
    return (dynCall_iffiffi = Module["dynCall_iffiffi"] =
      Module["asm"]["Uk"]).apply(null, arguments);
  });
  ...
  var dynCall_ifi = (Module["dynCall_ifi"] = function () {
    return (dynCall_ifi = Module["dynCall_ifi"] = Module["asm"]["Wk"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_diji = (Module["dynCall_diji"] = function () {
    return (dynCall_diji = Module["dynCall_diji"] = Module["asm"]["kl"]).apply(
      null,
      arguments
    );
  });
  var dynCall_fidi = (Module["dynCall_fidi"] = function () {
    return (dynCall_fidi = Module["dynCall_fidi"] = Module["asm"]["ll"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_viiiiiiffiii = (Module["dynCall_viiiiiiffiii"] = function () {
    return (dynCall_viiiiiiffiii = Module["dynCall_viiiiiiffiii"] =
  ...
  var dynCall_viiiiiiiiiiiiiiiffii = (Module["dynCall_viiiiiiiiiiiiiiiffii"] =
    function () {
      return (dynCall_viiiiiiiiiiiiiiiffii = Module[
        "dynCall_viiiiiiiiiiiiiiiffii"
      ] =
  ...
  var dynCall_viiffffffffffffiiiii = (Module["dynCall_viiffffffffffffiiiii"] =
    function () {
      return (dynCall_viiffffffffffffiiiii = Module[
  ...
  var dynCall_vffi = (Module["dynCall_vffi"] = function () {
    return (dynCall_vffi = Module["dynCall_vffi"] = Module["asm"]["Fl"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_vfi = (Module["dynCall_vfi"] = function () {
    return (dynCall_vfi = Module["dynCall_vfi"] = Module["asm"]["Rl"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_ffii = (Module["dynCall_ffii"] = function () {
    return (dynCall_ffii = Module["dynCall_ffii"] = Module["asm"]["Nm"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_jjii = (Module["dynCall_jjii"] = function () {
    return (dynCall_jjii = Module["dynCall_jjii"] = Module["asm"]["tn"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_dddi = (Module["dynCall_dddi"] = function () {
    return (dynCall_dddi = Module["dynCall_dddi"] = Module["asm"]["Xn"]).apply(
      null,
      arguments
    );
  });
  var dynCall_ddi = (Module["dynCall_ddi"] = function () {
    return (dynCall_ddi = Module["dynCall_ddi"] = Module["asm"]["Yn"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_vdii = (Module["dynCall_vdii"] = function () {
    return (dynCall_vdii = Module["dynCall_vdii"] = Module["asm"]["ko"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_didi = (Module["dynCall_didi"] = function () {
    return (dynCall_didi = Module["dynCall_didi"] = Module["asm"]["no"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_di = (Module["dynCall_di"] = function () {
    return (dynCall_di = Module["dynCall_di"] = Module["asm"]["yo"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_ijj = (Module["dynCall_ijj"] = function () {
    return (dynCall_ijj = Module["dynCall_ijj"] = Module["asm"]["No"]).apply(
      null,
      arguments
    );
  });
  var dynCall_vjji = (Module["dynCall_vjji"] = function () {
    return (dynCall_vjji = Module["dynCall_vjji"] = Module["asm"]["Oo"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_vif = (Module["dynCall_vif"] = function () {
    return (dynCall_vif = Module["dynCall_vif"] = Module["asm"]["Ro"]).apply(
      null,
      arguments
    );
  });
  var dynCall_vid = (Module["dynCall_vid"] = function () {
    return (dynCall_vid = Module["dynCall_vid"] = Module["asm"]["So"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_iif = (Module["dynCall_iif"] = function () {
    return (dynCall_iif = Module["dynCall_iif"] = Module["asm"]["rp"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_vidd = (Module["dynCall_vidd"] = function () {
    return (dynCall_vidd = Module["dynCall_vidd"] = Module["asm"]["xp"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_viid = (Module["dynCall_viid"] = function () {
    return (dynCall_viid = Module["dynCall_viid"] = Module["asm"]["zp"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_vij = (Module["dynCall_vij"] = function () {
    return (dynCall_vij = Module["dynCall_vij"] = Module["asm"]["Ip"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_vfff = (Module["dynCall_vfff"] = function () {
    return (dynCall_vfff = Module["dynCall_vfff"] = Module["asm"]["Mp"]).apply(
      null,
      arguments
    );
  });
  var dynCall_iiff = (Module["dynCall_iiff"] = function () {
    return (dynCall_iiff = Module["dynCall_iiff"] = Module["asm"]["Np"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_ff = (Module["dynCall_ff"] = function () {
    return (dynCall_ff = Module["dynCall_ff"] = Module["asm"]["Pp"]).apply(
      null,
      arguments
    );
  });
  var dynCall_if = (Module["dynCall_if"] = function () {
    return (dynCall_if = Module["dynCall_if"] = Module["asm"]["Qp"]).apply(
      null,
      arguments
    );
  });
